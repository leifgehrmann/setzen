...
const cameraMoveXDirection = ref(0);
const cameraMoveYDirection = ref(0);
const cameraZoomDirection = ref(0);
const cameraRotateDirection = ref(0);
const percentLoaded = ref(0);
const loaded = ref(false);
const connectionStatus = ref('disconnected' as 'disconnected' | 'connecting' | 'connected');
const selectedPosition = ref(null as number | null);
