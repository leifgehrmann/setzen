<template>
  ...
  <section>
    ...
    <details>
      ...
      <p>{{webAppHostCapitalized}} is hosted on GitHub Pages, a service provided by GitHub Inc. which have <a href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement#github-pages">their own privacy policy</a>.</p>
    </details>
    <details>
      <summary>Amazon Web Services, Inc.</summary>
      <p>{{webAppHostCapitalized}} uses Amazon API Gateway, a service provided by Amazon Web Services Inc. which have <a href="https://aws.amazon.com/privacy/">their own privacy policy</a>.</p>
    </details>
  </section>
</template>
